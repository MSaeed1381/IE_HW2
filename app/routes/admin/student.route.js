...
router.route('/admin/student/:id')
    ...
    .get([Auth.isAuthenticated, RoleHandler.isAdmin], StudentController.getStudentById)
    .delete([Auth.isAuthenticated, RoleHandler.isAdmin], StudentController.delete);

router.route('/admin/students')
    .get([Auth.isAuthenticated, RoleHandler.isAdmin], StudentController.getAllStudents)
